  ...
  <div class="contact-info">
    ...
    <div class="contact-detail">
      <div class="contact-detail-icon">
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M9 2C6.24 2 4 4.24 4 7c0 4.25 5 9 5 9s5-4.75 5-9c0-2.76-2.24-5-5-5zm0 6.5A1.5 1.5 0 1 1 9 5a1.5 1.5 0 0 1 0 3.5z" fill="#FF6B1A"/></svg>
      </div>
    ...
    <div class="contact-detail">
      <div class="contact-detail-icon">
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M3 3h12a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1zm6 6L4 6h10L9 9z" fill="#FF6B1A"/></svg>
      </div>
      <div class="contact-detail-text">
    ...
    <div class="contact-detail">
      <div class="contact-detail-icon">
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M3.6 2h3l1.5 3.75-1.8 1.05C7.2 8.7 9.3 10.8 11.2 11.7L12.25 9.9 16 11.4v3c0 .55-.45 1-1 1C7.3 15.4 2.6 10.7 2.6 5 2.6 4.45 3.05 4 3.6 4v-2z" fill="#FF6B1A"/></svg>
      </div>
      <div class="contact-detail-text">
  ...
  <div class="form-card">
    ...
    <form id="contact-form">
      ...
      <div class="form-group">
        ...
        <input type="text" id="firma" name="firma" placeholder="Muster">
      </div>

      <div class="form-group">
        <label for="email">E-Mail-Adresse *</label>
        <input type="email" id="email" name="email" placeholder="max@muster.de" required>
      </div>

      <div class="form-group">
        <label for="rolle">Ich bin …</label>
        <select id="rolle" name="rolle">
          <option value="">Bitte auswählen</option>
          <option value="gu">Generalunternehmer / Bauträger</option>
          <option value="hersteller">Estrich-Hersteller / Baustoffhandel</option>
          <option value="estrichleger">Estrichleger / Handwerker</option>
          <option value="planer">Architekt / Planer</option>
      ...
      <div class="form-group">
        ...
        <input type="text" id="betreff" name="betreff" placeholder="z.B. Pilotprojekt, Demo, Partnerschaft …">
      </div>

      <div class="form-group">
        <label for="nachricht">Ihre Nachricht *</label>
        <textarea id="nachricht" name="nachricht" placeholder="Beschreiben Sie kurz Ihr Anliegen oder Ihren Anwendungsfall …" required></textarea>
      </div>
